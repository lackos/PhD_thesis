...
\linebreak
\cite{LDFDs2019} \bibentry{LDFDs2019} (Not included in thesis) \\
...
\addcontentsline{lof}{chapter}{Chapter 2: Fundamental symmetries and their violation}
%\addcontentsline{lot}{chapter}{Chapter 2: Fundamental symmetries and their violation}
...
\addcontentsline{lof}{chapter}{Chapter 3: Properties of deformed nuclei}
%\addcontentsline{lot}{chapter}{Chapter 3: Properties of deformed nuclei}
...
%\addcontentsline{lof}{chapter}{Chapter 4: The weak quadrupole moment and Lorentz violation in nuclei}
\addcontentsline{lot}{chapter}{Chapter 4: The weak quadrupole moment and Lorentz violation in nuclei}
...
%\addcontentsline{lof}{chapter}{Chapter 5: The magnetic quadrupole moment of the nucleus}
\addcontentsline{lot}{chapter}{Chapter 5: The magnetic quadrupole moment of the nucleus}
...
\addcontentsline{lof}{chapter}{Chapter 8: The CIPT method}
\addcontentsline{lot}{chapter}{Chapter 8: The CIPT method}
...
\caption[Comparison of experimental and CIPT spectra and ionisation potential of Ta~I]{Comparison of experimental (from Ref.\cite{NIST_ASD}) and CIPT spectra and ionisation potential of Ta I. The experimental excitation energies ($E_E$) and Land\'{e} g-factors ($g_E$) are compared to respective CIPT excitation energies ($E_T$) and Land\'{e} g-factors ($g_T$).   The final column is the difference between experimental and theoretical excitation energies $\Delta = E_{E} - E_{T}$. The results of this table were published in Ref. \cite{LDFDb2018} \label{tab:TaComparison}}\\
\endfirsthead
\multicolumn{5}{c}%
...
\addcontentsline{lof}{chapter}{Chapter 9: Atomic structure of super heavy element Db}
\addcontentsline{lot}{chapter}{Chapter 9: Atomic structure of super heavy element Db}
...
\addcontentsline{lof}{chapter}{Chapter 10: Atomic structure of super heavy elements Sg, Bh, Hs and Mt}
\addcontentsline{lot}{chapter}{Chapter 10: Atomic structure of super heavy elements Sg, Bh, Hs and Mt}
...
\caption[ \quad Theoretical and experimental ionisation potentials of open $5d$-shell elements.]{Theoretical and experimental ionisation potentials of open $5d$-shell elements.  The CIPT energies are the results of the present work. \label{tab:IP}}
\endfirsthead
\multicolumn{5}{c}%
{\tablename\ \thetable\ -- \textit{Continued from previous page}} \\
\hline
...
\caption[ \quad Some excitation energies in open $6d$-shell SHE and each lighter analog]{Some excitation energies (cm$^{-1}$) in open $6d$-shell SHE and their lighter analogs. The CIPT energies are the results of the present work.   \label{tab:EE}}
\endfirsthead
\multicolumn{5}{c}%
{\tablename\ \thetable\ -- \textit{Continued from previous page}} \\
\hline
...
\linebreak
A similar manifestation of relativistic effects can be found in the trends of further ionisation of the SHE ions (see Table~\ref{tab:SHEIP}). In many cases (e.g., the Bh and Hs ions) ionisation from the $6d$ shell stops as soon as the fully filled $6d_{3/2}^4$ subshell is reached. Further ionisation occurs from the $7s$ subshell.
\afterpage{
\begin{longtable}{llccccc}
\caption[ \quad Ionisation potentials of open $6d$-shell SHE, including ions]{Ionisation potentials of open $6d$-shell SHE, including ions.  The CIPT energies are the results of the present work. \label{tab:SHEIP}}
\endfirsthead
\multicolumn{5}{c}%
{\tablename\ \thetable\ -- \textit{Continued from previous page}} \\
\hline
...
\end{figure}
 ...
 \addcontentsline{lof}{chapter}{Chapter 11: Atomic structure of oganesson}
\addcontentsline{lot}{chapter}{Chapter 11: Atomic structure of oganesson}
...
\addcontentsline{lof}{chapter}{Chapter A: Nilsson Orbitals}
\addcontentsline{lot}{chapter}{Chapter A: Nilsson Orbitals}
