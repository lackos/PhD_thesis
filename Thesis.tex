...
The three fundamental discrete symmetries are parity $P-$, time reversal $T-$ and charge conjugation $C-$. 
...
A cornerstone of modern quantum field theory is the CPT theorem. In essence it states that all physical phenomena are CPT-even which means under the application of the three operators the system is unchanged. 
...
\chapter{Non-spherical nuclei and their enhancement of violation of fundamental symmetries}
\section{Deformed nuclei}
\section{$CP-$ violation in deformed nuclei}
\section{Lorentz violation in deformed nuclei}
\section{Weak quadrupole moments}
\chapter{Conclusion}
