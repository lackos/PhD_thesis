...
The violation of fundamental symmetries of nature is one of the most important aspects of modern physics. Detection of these violations in the past has resulted in large leaps in the understanding of the fundamental physics and interactions which govern the laws of physics. Therefore the quest detect and quantify further violations of symmetries, particularly those which current physics deems necessary, is one of the largest in and most concerted and spans high energy and cosmological down to low energy atomic and nuclear experiments. In this thesis I have demonstrated that the quadrupole properties of deformed nuclei present a lucrative opportunity to detect these violations.\\
\linebreak
...
The study of elements at the extreme end of the periodic table has been a cornerstone of science for centuries. Currently the progress of this filed is experimentally limited due to the large cost of these facilities and and the low short lifetimes and low production rates for superheavy elements. Therefore with experimental results of spectroscopic properties of these elements sparse physicists must look towards theoretical many-body models to study these techniques. In this thesis I have presented results from many-body treatment of the electronic structure of some of these SHEs. Specifically, I have presented the low lying energy spectrum of Db, Sg, Bh, Hs, Mt and Og elements along with the strong optical E1 transitions from the CIPT method. \\
\linebreak
One of the most promising use of these results is in detecting nuclei in the island of stability. New results \cite{Alexandrov2019} show that 
