...
Along with high energy decay processes, the existence of some permanent electromagnetic moments also violate fundamental symmetries. The fundamental violating electrodynamic moment is the electron dipole moment (EDM). The existence of a permanent EDM violates both $P-$ and $T-$ (and therefore also $CP-$) symmetries. Consider a particle with angular moment $\textbf{I}$, the EDM $\textbf{d}$ must be aligned with the angular momentum $\textbf{d} = d\textbf{I}$. 
...
\section{Deformed nuclei and the Nilsson Model}
...
Searching for $CP-$ violating EDMs through direct measurement is difficult
...
\textit{The results of this chapter have been published in } \\
\linebreak
